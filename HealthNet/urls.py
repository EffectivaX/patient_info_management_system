...
urlpatterns = [
    ...
    path('HealthNet/patients/patient_form/',
         views.patient_form,
         name='Patient Form'),
    path('HealthNet/patients/patient_info/<int:id>/',
         views.patient_info,
         name='patient_info'),
    path('HealthNet/patients/edit_patient/<int:pk>/',
         views.edit_patient,
         name='edit_info'),
    path('HealthNet/patients/delete_patient/<int:id>/',
    ...
    path('HealthNet/Doctors/delete_doctor/<int:id>/',
         views.delete_doctor,
         name='Delete Doctor'),
    path('HealthNet/Doctors/patients/<int:id>/',
         views.assigned_patient,
         name='Assigned Patients'),
    # Staff Members
    path('HealthNet/Staff/new_member/',
         views.add_staff_member,
         name="Add Staff Member"),
    path('HealthNet/Staff/all_members/', views.all_members,
         name='All Members'),
    path('HealthNet/Doctors/update_doctor/<int:id>/',
         views.update_doctor,
         name='Edit Staff Member'),
    path('HealthNet/Staff/edit_member/<int:id>/',
         views.update_member,
         name='Edit Staff Member'),
    # path('HealthNet/Staff/StaffMemberUpdate/<int:id>', views.StaffMemberUpdate, name='Edit Staff'),
    path('HealthNet/Staff/delete_member/<int:id>/',
         views.delete_staff_member,
         name='Delete Member'),

    # Dynamic Routing
    path('HealthNet/medical_aid_groups/',
         views.medical_aid_groups,
         name="Medical AID Groups")
]
