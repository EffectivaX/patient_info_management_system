...
urlpatterns = [
    ...
    path('HealthNet/patients/edit_patient/<int:id>/', views.edit_patient, name='edit_info'),
    ...
    # Contact Page url
    path('HealthNet/contact/', views.contact, name='Contact'),
    ...
    path('HealthNet/staff/add_staff_member/', views.add_staff_member, name="Add Staff Member"),
    ...
    path('HealthNet/staff/delete_staff_member/<int:id>/', views.delete_staff_member, name='Delete Member'),
