...
urlpatterns = [
    ...
    path('HealthNet/patients/edit_patient/<int:id>/change/', views.edit_patient, name='edit_info'),
    path('HealthNet/patients/delete_patient/<int:id>/delete/', views.delete_patient, name='Delete'),
